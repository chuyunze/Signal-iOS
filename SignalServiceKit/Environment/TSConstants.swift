...
public class TSConstantsProduction: TSConstantsProtocol {
    ...
    // 自建服务器: 与 prod-secrets-bundle.yml 的 callingZkConfigPreV101/callingZkConfigV101/chatZkConfig
    // serverSecret (官方测试密钥 AIZmPk8m...) 配对的 GenericServerPublicParams
    public let callLinkPublicParams = Data(base64Encoded: "")!
